...
var DataCell = _react2.default.memo(function (_PureComponent) {
  ...
  _createClass(_class2, [{
    ...
    value: function render() {
      ...
      var content = editing ? this.renderContent(editing, cell, row, col, dataEditor, valueRenderer, valueViewer) : this.memoizedRenderContent(editing, cell, row, col, dataEditor, valueRenderer, valueViewer);
