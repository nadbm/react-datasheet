...
var DataSheet = function (_PureComponent) {
  ...
  function DataSheet(props) {
    ...
    props.refChangeSelection(_this.changeSelection);
    return _this;
  }
  ...
  _createClass(DataSheet, [{
    ...
    value: function changeSelection() {
      var start = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { i: 0, j: 0 };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { ref: function ref(r) {
            _this5.dgDom = r;
          }, tabIndex: '0', className: ['data-grid-container', containerClassName].filter(function (a) {
            return a;
          }).join(' '), onKeyDown: this.handleKey },
...
DataSheet.propTypes = {
  ...
  refChangeSelection: _propTypes2.default.func
};
...
DataSheet.defaultProps = {
  ...
  refChangeSelection: function refChangeSelection() {}
};